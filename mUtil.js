...
module.exports = {
	...
	staticHanlder : function (filePath, req, res) {  		
	  	var content_type = lookupExtension(path.extname(filePath)),
...
function lookupExtension(ext, fallback) {
	return memeTypes[ext.toLowerCase()] || fallback || 'application/octet-stream';
}
var memeTypes = { 
		  ".3gp"   : "video/3gpp"
